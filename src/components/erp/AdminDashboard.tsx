          ...
          <div className="flex flex-wrap gap-2.5">
            {onOpenAnnouncementModal && (
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold px-4 py-2.5 rounded-xl text-xs flex items-center gap-1.5 shadow-md shadow-purple-600/30 transition-all hover:scale-[1.02] active:scale-95 cursor-pointer"
              >
            ...
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold px-4 py-2.5 rounded-xl text-xs flex items-center gap-1.5 shadow-md shadow-indigo-600/30 transition-all hover:scale-[1.02] active:scale-95 cursor-pointer"
            >
            ...
            {onOpenTeacherModal && (
              <button
                ...
                className="bg-slate-800 hover:bg-slate-700 text-white font-bold px-4 py-2.5 rounded-xl text-xs flex items-center gap-1.5 border border-slate-700 transition-all hover:scale-[1.02] active:scale-95 cursor-pointer"
              >
                <Plus className="w-4 h-4" />
            ...
            <button
              ...
              className="bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold px-4 py-2.5 rounded-xl text-xs border border-slate-700 transition-all cursor-pointer"
            >
              <span>+ New Batch</span>
            </button>
          </div>
                      ...
                      {(() => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-2.5 py-1 font-bold rounded-lg border text-[10px] flex items-center gap-1 transition-all ${
                              !phoneCheck.isValid
                                ? 'bg-slate-100 text-slate-400 border-slate-200 opacity-60 cursor-not-allowed'
                                : 'bg-white hover:bg-rose-100 text-rose-700 border-rose-200 cursor-pointer'
                            }`}
                            title={
                              phoneCheck.isValid
